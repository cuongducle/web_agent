...
npm run dev
                  ...
                  <>
                    ...
                    <p className="text-sm text-[--gray-11]">
                      3. Web Surf Agent will connect to your local Ollama instance automatically
                    </p>
                  </>
                )}
                {ollamaError && (
      ...
      <div className="mt-4 space-y-2">
        <h3 className="text-sm font-medium text-[--gray-12]">Installation</h3>
        <div className="rounded-md bg-[--gray-2] p-4">
          <SyntaxHighlighter
            language="bash"
            style={atomDark}
            customStyle={{
