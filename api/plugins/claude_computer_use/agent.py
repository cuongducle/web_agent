...
async def claude_computer_use(
    ...
    # Retrieve session using CDP service instead of Steel
    ...
    async with async_playwright() as p:
        # Connect to CDP directly using the WebSocket URL from our session
        browser = await p.chromium.connect_over_cdp(session.ws_url)
