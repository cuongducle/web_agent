...
from tools import ClaudeComputerTool, GetCurrentUrlTool, GoToUrlTool

# CDP environment variables
CDP_WS_ENDPOINT = os.getenv("CDP_WS_ENDPOINT")


async def test_basic_navigation():
    """Test basic navigation using CDP and tools"""
    print("\n=== Starting basic navigation test ===")

    # Connect Playwright to CDP endpoint
    playwright = await async_playwright().start()
    browser = await playwright.chromium.connect_over_cdp(CDP_WS_ENDPOINT)
